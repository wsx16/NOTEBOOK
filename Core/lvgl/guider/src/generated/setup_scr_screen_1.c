...
void setup_scr_screen_1(lv_ui *ui)
{
    ...
    lv_img_set_src(ui->screen_1_img_1, &_3_alpha_240x320);
    ...
    lv_imgbtn_set_src(ui->screen_1_imgbtn_1, LV_IMGBTN_STATE_PRESSED, NULL, &_2_alpha_240x320, NULL);
    ...
    lv_obj_set_pos(ui->screen_1_imgbtn_1, 0, 0);
    lv_obj_set_size(ui->screen_1_imgbtn_1, 240, 320);
