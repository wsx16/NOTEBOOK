...
void setup_scr_screen_2(lv_ui *ui)
{
    ...
    lv_imgbtn_set_src(ui->screen_2_imgbtn_1, LV_IMGBTN_STATE_PRESSED, NULL, &_4_alpha_240x320, NULL);
    ...
    lv_obj_set_pos(ui->screen_2_imgbtn_1, 0, 0);
    lv_obj_set_size(ui->screen_2_imgbtn_1, 240, 320);
